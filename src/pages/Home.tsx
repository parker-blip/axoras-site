...
export default function Home() {
    ...
    return (
      <div className="fixed inset-0 bg-[#0a0a0a] flex items-center justify-center z-50">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-yellow-400 text-sm font-medium tracking-wider animate-pulse">LOADING AXORA</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden selection:bg-yellow-400/30">
      ...
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-[#0a0a0a]/80 border-b border-white/5 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              <button onClick={() => navigate('/features')} className="text-sm text-zinc-400 hover:text-white transition-colors duration-300">Features</button>
              <a href="#clients" className="text-sm text-zinc-400 hover:text-white transition-colors duration-300">Download</a>
      ...
      <section id="clients" className="py-32 px-6 relative">
        <div className="max-w-7xl mx-auto">
          ...
          {clients.length === 0 ? (
            <div className="text-center py-20 px-6 bg-zinc-900/30 rounded-2xl border border-zinc-800">
              ...
              {clients.map((client, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-zinc-800">
                    ...
                    <div className="flex items-center gap-1 text-yellow-400 text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity">
      ...
      <section className="py-32 px-6">
        <div className="max-w-4xl mx-auto text-center relative">
          <div className="absolute inset-0 bg-gradient-to-r from-yellow-400/10 to-yellow-600/10 rounded-3xl blur-3xl" />
          <div className="relative bg-zinc-900/50 rounded-3xl p-12 border border-zinc-800">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Ready to Dominate?</h2>
